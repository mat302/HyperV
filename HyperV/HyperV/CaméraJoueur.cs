...
namespace HyperV
{
    public class CaméraJoueur : AtelierXNA.Caméra
    {
        ...
        const float DELTA_LACET = MathHelper.Pi / 180; // 1 degré é la fois
        ...
        private void AffecterCommandes()
        {
            ...
            Sauter = GestionInput.EstEnfoncée(Keys.Space) || 
        ...
        private void GérerRamassage()
        {
            ...
            foreach (SphéreRamassable sphereRamassable in Game.Components.Where(composant => composant is SphéreRamassable))
            {
